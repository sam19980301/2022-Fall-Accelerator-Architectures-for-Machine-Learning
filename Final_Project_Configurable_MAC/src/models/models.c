...
static struct Menu MENU = {
    ...
    "models",
    {
        MENU_ITEM(AUTO_INC_CHAR, "MLP_8x8 model", MLP_8x8_menu),
        MENU_ITEM(AUTO_INC_CHAR, "MLP_16x8 model", MLP_16x8_menu),
        MENU_ITEM(AUTO_INC_CHAR, "MLP_32x32 model", MLP_32x32_menu),
        MENU_ITEM(AUTO_INC_CHAR, "ResNet model", resnet_menu),
